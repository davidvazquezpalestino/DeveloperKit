...
public partial class OracleProvider : IOracleProvider, IAsyncDisposable
{
    ...
    /// <summary>Inicializa una nueva instancia de <see cref="OracleProvider"/> usando el patrón Options.</summary>
    ...
    public OracleProvider(IOptions<OracleOptions> options)
    {
        OracleOptions = options.Value;
