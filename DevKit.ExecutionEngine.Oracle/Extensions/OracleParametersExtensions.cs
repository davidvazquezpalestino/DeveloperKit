...
public static class OracleParametersExtensions
{
    ...
    /// <param name="collection">Colección de parámetros a la que se agregarán los nuevos parámetros</param>
    ...
    /// <param name="log">Delegado para registrar mensajes (opcional)</param>
    /// <returns>La misma colección de parámetros para permitir el encadenamiento de métodos</returns>
    public static IDataParameterCollection AsOracleParameters(this IDataParameterCollection collection, Dictionary<string, object> dictionary, Action<string> log = null)
    {
        try
        {
