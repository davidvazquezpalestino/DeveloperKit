namespace DevKit.ExecutionEngine.SQLServer.Extensions
{
    ...
    public static partial class SqlQueryBuilderExtensions
    {
        ...
        public static async Task<T> FirstAsync<T>(this QueryState<T> queryState, Expression<Func<T, bool>> predicate, CancellationToken cancellationToken = default)
            where T : class, new()
        {
        ...
        public static async Task<int> CountAsync<T>(this QueryState<T> queryState, Expression<Func<T, bool>> predicate, CancellationToken cancellationToken = default)
            where T : class, new()
        {
        ...
        public static async Task<bool> AnyAsync<T>(this QueryState<T> queryState, Expression<Func<T, bool>> predicate, CancellationToken cancellationToken = default)
            where T : class, new()
        {
