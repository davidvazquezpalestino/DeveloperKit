...
public partial class ExcelDatabaseProvider : IExcelDatabaseProvider
{
    /// <inheritdoc/>
    ...
    public ExcelDatabaseProvider() { }

    /// <summary>Inicializa una nueva instancia de la clase ExcelDatabaseProvider con la ruta del archivo Excel.</summary>
    public ExcelDatabaseProvider(string connectionString) => SetDatabaseLogon(connectionString);
    ...
    public ExcelDatabaseProvider(Stream stream) => SetDatabaseLogon(stream);
    ...
    ~ExcelDatabaseProvider() => Dispose(false);
