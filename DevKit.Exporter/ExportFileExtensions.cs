...
public static class ExportFileExtensions
{
    ...
    public static void ExportToMicrosoftExcel(this DataTable table, string fileName)
    {
    ...
    public static void ExportToMicrosoftExcel(this IEnumerable<Dictionary<string, object>> dictionary, string fileName)
    {
        GuardAgainstInvalidExcelExtension(fileName);
    ...
    public static void ExportToMicrosoftExcel<T>(this IEnumerable<T> data, string fileName)
    {
        GuardAgainstInvalidExcelExtension(fileName);
    ...
    public static MemoryStream ExportToMicrosoftExcel(this DataTable table)
    {
    ...
    public static MemoryStream ExportToMicrosoftExcel<T>(this IEnumerable<T> data)
    {
    ...
    public static MemoryStream ExportToMicrosoftExcel(this IEnumerable<Dictionary<string, object>> dictionary)
    {
