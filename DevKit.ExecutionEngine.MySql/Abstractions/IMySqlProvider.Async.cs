...
public partial interface IMySqlProvider
{
    /// <summary>
    ...
    /// <summary>
    /// Ejecuta un comando y devuelve un único valor escalar de forma asíncrona.
    /// </summary>
    /// <typeparam name="T">Tipo del valor a devolver.</typeparam>
    /// <param name="query">Consulta SQL a ejecutar.</param>
    /// <param name="parameters">Parámetros de la consulta.</param>
    /// <param name="cancellationToken">Token de cancelación opcional.</param>
    /// <returns>Valor escalar resultante de la consulta.</returns>
    Task<T> ExecuteScalarAsync<T>(string query, Action<IDataParameterCollection> parameters = null, CancellationToken cancellationToken = default);
