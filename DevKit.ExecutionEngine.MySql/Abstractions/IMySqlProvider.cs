...
/// </summary>
public partial interface IMySqlProvider : IAsyncDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Ejecuta un comando y devuelve un único valor escalar.
    /// </summary>
    ...
    T ExecuteScalar<T>(string query, Action<IDataParameterCollection> parameters = null);
